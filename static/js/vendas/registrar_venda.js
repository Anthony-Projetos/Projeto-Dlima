(function () {
    ...
    function buildLabelTSPL(dados, quantidade) {
        ...
        return [
            ...
            buildRotatedCenteredTsplText(28, "D'LIMA", { font: '3', xMultiplier: 2, maxWidthDots: 260 }),
            ...
            buildRotatedCenteredTsplText(452, 'NAO SEJA COPIA, SEJA REFERENCIA', { font: '1', maxWidthDots: 260 }),
            `PRINT ${copies}`,
            '',
        ].join('\r\n');
    }
