...
class LabelPrintingFrontendTests(TestCase):
    def test_js_de_etiquetas_usa_tspl_raw_60x40(self):
        ...
        self.assertIn('if (words.length === 2)', source)
        self.assertIn('return words;', source)
        self.assertIn('function getProductTsplFont(value)', source)
        self.assertIn('function getProductLinesTsplFont(lines)', source)
        ...
        self.assertIn('PRODUCT_LINE_MAX_WIDTH_DOTS = 288', source)
        ...
        self.assertNotIn('buildRotatedTsplBar(0, 106, LABEL_LAYOUT_WIDTH_DOTS, 3)', source)
        ...
        self.assertNotIn('buildRotatedTsplBar(0, 420, LABEL_LAYOUT_WIDTH_DOTS, 3)', source)
        ...
        self.assertIn('const productFont = getProductLinesTsplFont(productLines)', source)
        self.assertIn('font: productFont', source)
        self.assertIn('largeTextWidth <= PRODUCT_LINE_MAX_WIDTH_DOTS', source)
        self.assertIn('mediumTextWidth <= PRODUCT_LINE_MAX_WIDTH_DOTS', source)
        self.assertIn('maxWidthDots: PRODUCT_LINE_MAX_WIDTH_DOTS', source)
        self.assertIn("buildRotatedTsplText(200, 274, 'TAM:'", source)
        self.assertIn("buildRotatedCenteredTsplText(274, tamanho, { font: '4', maxWidthDots: 120 })", source)
        self.assertIn("buildRotatedCenteredTsplText(360, preco, { font: '4', maxWidthDots: 288 })", source)
        self.assertIn('buildRotatedCenteredTsplText(434, footerText', source)
        self.assertIn("buildRotatedTsplText(62, 462, 'NAO SEJA COPIA,SEJA REFERENCIA'", source)
        ...
        self.assertNotIn('.label-simple-details,\n.label-simple-price', css)
        self.assertNotIn('.label-simple-brand,\n.label-simple-product', css)
        ...
        self.assertIn("css/style.css' %}?v=label-sideways-no-price-line-20260602", template)
        self.assertIn("js/vendas/registrar_venda.js' %}?v=label-sideways-no-price-line-20260602", template)
