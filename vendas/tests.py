...
class LabelPrintingFrontendTests(TestCase):
    def test_js_de_etiquetas_usa_tspl_raw_60x40(self):
        ...
        self.assertIn('buildTsplBar(12, 12, 456, 2)', source)
        self.assertIn('buildTsplBar(12, 306, 456, 2)', source)
        self.assertIn('buildTsplBar(12, 12, 2, 296)', source)
        self.assertIn('buildTsplBar(468, 12, 2, 296)', source)
        self.assertIn('buildTsplBar(24, 72, 432, 2)', source)
        self.assertIn('buildTsplBar(24, 158, 432, 2)', source)
        self.assertIn('buildTsplBar(24, 248, 432, 2)', source)
        self.assertIn('buildTsplBar(178, 168, 2, 74)', source)
        self.assertIn('buildTsplBar(300, 168, 2, 74)', source)
        self.assertIn("buildCenteredTsplText(26, \"D'lima Store\"", source)
        self.assertIn('buildCenteredTsplText(84, productLines[0]', source)
        self.assertIn('buildCenteredTsplText(116, productLines[1]', source)
        self.assertIn("buildTsplText(34, 176, 'REF.'", source)
        self.assertIn('buildTsplText(34, 204, referencia', source)
        self.assertIn("buildTsplText(204, 176, 'TAM.'", source)
        self.assertIn('buildTsplText(218, 202, tamanho', source)
        self.assertIn("buildTsplText(326, 176, 'VALOR'", source)
        self.assertIn('buildTsplText(314, 202, preco', source)
