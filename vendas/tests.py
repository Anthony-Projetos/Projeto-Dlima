...
class LabelPrintingFrontendTests(TestCase):
    def test_js_de_etiquetas_usa_tspl_raw_60x40(self):
        ...
        self.assertIn("buildRotatedCenteredTsplText(28, \"D'LIMA\"", source)
        self.assertIn("buildRotatedCenteredTsplText(66, 'S T O R E'", source)
        self.assertIn('buildRotatedCenteredTsplText(110, productLines[0]', source)
        self.assertIn('buildRotatedCenteredTsplText(174, productLines[1]', source)
        self.assertIn("buildRotatedTsplText(26, 274, 'TAM:'", source)
        self.assertIn('buildRotatedCenteredTsplText(260, tamanho', source)
        self.assertIn('buildRotatedCenteredTsplText(350, preco', source)
        self.assertIn('buildRotatedCenteredTsplText(434, footerText', source)
        self.assertIn("buildRotatedCenteredTsplText(452, 'NAO SEJA COPIA, SEJA REFERENCIA'", source)
        ...
        self.assertIn("css/style.css' %}?v=label-sideways-fit-20260602", template)
        self.assertIn("js/vendas/registrar_venda.js' %}?v=label-sideways-fit-20260602", template)
