...
class LabelPrintingFrontendTests(TestCase):
    def test_js_de_etiquetas_usa_tspl_raw_60x40(self):
        ...
        self.assertIn('buildTsplBar(212, 24, 2, 272)', source)
        self.assertIn('buildTsplBar(368, 24, 2, 272)', source)
        self.assertIn('buildTsplBar(432, 24, 2, 272)', source)
        self.assertIn('buildTsplBar(226, 184, 132, 2)', source)
        self.assertIn('buildTsplBar(288, 202, 2, 92)', source)
        self.assertIn("buildTsplText(40, 236, \"D'lima\"", source)
        self.assertIn("buildTsplText(74, 176, 'store'", source)
        self.assertIn('buildTsplText(112, 292, productLines[0]', source)
        self.assertIn('buildTsplText(160, 292, productLines[1]', source)
        self.assertIn("buildTsplText(226, 168, 'VALOR'", source)
        self.assertIn('buildTsplText(274, 252, preco', source)
        self.assertIn("buildTsplText(226, 292, 'REF.'", source)
        self.assertIn('buildTsplText(250, 292, referencia', source)
        self.assertIn('buildTsplText(310, 292, tamanho', source)
