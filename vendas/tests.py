...
class LabelPrintingFrontendTests(TestCase):
    def test_js_de_etiquetas_usa_tspl_raw_60x40(self):
        ...
        self.assertIn('buildRotatedTsplBar(0, 106, LABEL_LAYOUT_WIDTH_DOTS, 3)', source)
        ...
        self.assertIn("buildRotatedCenteredTsplText(260, tamanho, { font: '4', maxWidthDots: 120 })", source)
        ...
        self.assertIn("css/style.css' %}?v=label-sideways-scale-line-20260602", template)
        self.assertIn("js/vendas/registrar_venda.js' %}?v=label-sideways-scale-line-20260602", template)
