...
class LabelPrintingFrontendTests(TestCase):
    def test_js_de_etiquetas_usa_tspl_raw_60x40(self):
        ...
        self.assertIn("buildRotatedCenteredTsplText(20, \"D'LIMA\"", source)
        ...
        self.assertIn("css/style.css' %}?v=label-sideways-align-20260602", template)
        self.assertIn("js/vendas/registrar_venda.js' %}?v=label-sideways-align-20260602", template)
